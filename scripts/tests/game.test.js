...
describe('newGame works correctly', () => {
    ...
    test('should diaply zero for the element with id of score', () => {
...
describe('gameplay works correctly', () => {
    ...
    test('should add correct class to the light up the buttons', () => {
    ...
    test('should call an alert fi the move is wrong', () => {
